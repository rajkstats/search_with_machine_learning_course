...
PRODUCTS_JSON_FILE="/workspace/search_with_machine_learning_course/week4/bbuy_products.json"
QUERIES_JSON_FILE="/workspace/search_with_machine_learning_course/week4/bbuy_queries.json"
